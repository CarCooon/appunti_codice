...
\cleardoublepage
\input{capitoli/cap1_stack}

\cleardoublepage
\input{capitoli/cap2_queue}

\cleardoublepage
\input{capitoli/cap3_alberi}

\cleardoublepage
\input{capitoli/cap4_bst}

\cleardoublepage
\input{capitoli/cap5_avl}

\cleardoublepage
\input{capitoli/cap6_rb}

\cleardoublepage
\input{capitoli/cap7_hash}

\cleardoublepage
\input{capitoli/cap8_sorUnsTable}

\cleardoublepage
\input{capitoli/cap9_chainHash}

\cleardoublepage
\input{capitoli/cap10_probeHash}

\cleardoublepage
\input{capitoli/cap11_priorityQueue}

\cleardoublepage
\input{capitoli/cap12_sorUnsQueue}

\cleardoublepage
\input{capitoli/cap13_heap}

\cleardoublepage
\input{capitoli/cap14_adaptable}

\cleardoublepage
\input{capitoli/cap15_graph}

\cleardoublepage
\input{capitoli/cap16_dfs}

\cleardoublepage
\input{capitoli/cap17_bfs}

\cleardoublepage
\input{capitoli/cap18_transitive}

\cleardoublepage
\input{capitoli/cap19_topological}

\cleardoublepage
\input{capitoli/cap20_shortestPath}

\cleardoublepage
\input{capitoli/cap21_mst}
