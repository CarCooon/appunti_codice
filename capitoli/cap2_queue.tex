...
\begin{lstlisting}[
    language=Python,
    caption={Classe astratta che implementa l'ADT Queue.},
    captionpos=b,
    label={lst:ADT_Queue},
]
class Queue:
...
\begin{lstlisting}[
    language=Python,
    caption={Implementazione Python dell'ADT Queue utilizzando una lista per la memorizzazione degli elementi.},
    captionpos=b,
    label={lst:ArrayQueue},
    firstnumber=43
]
