...
\label{cap:topological}

\begin{lstlisting}[
    language=Python,
    caption={Ordinamento topologico di un grafo diretto aciclico (DAG): risoluzione sequenziale dei vincoli di precedenza basata sul grado entrante.},
    label={lst:TopologicalSort}
]
