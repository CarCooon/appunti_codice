\chapter{Sorted Unsorted Table}
\label{cap:sorUnsTable}

\begin{lstlisting}[
    language=Python,
    caption={Implementazione di una mappa tramite tabella ordinata (Sorted Table).},
    label={lst:SortedTableMap}
]
...
\begin{lstlisting}[
    language=Python,
    caption={Implementazione di una mappa tramite tabella non ordinata (Unsorted Table).},
    label={lst:UnsortedTableMap}
]
from .map_base import MapBase
