...
\label{cap:shortestPath}

\begin{lstlisting}[
    language=Python,
    caption={Algoritmo di Dijkstra per i cammini minimi: calcolo delle distanze tramite rilassamento degli archi e ricostruzione dell'albero dei cammini minimi.},
    label={lst:DijkstraImplementation}
]
