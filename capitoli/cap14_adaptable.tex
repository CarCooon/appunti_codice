\chapter{Adaptable Priority Queue}
\label{cap:adaptable}

\begin{lstlisting}[
    language=Python,
    caption={Implementazione di AdaptableHeapPriorityQueue: estensione dello heap con oggetti Locator per la modifica (update) e rimozione (remove) efficiente di elementi.},
    label={lst:AdaptableHeap}
]
