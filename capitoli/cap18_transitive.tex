...
\label{cap:transitive}

\begin{lstlisting}[
    language=Python,
    caption={Calcolo della chiusura transitiva tramite l'algoritmo di Floyd-Warshall: approccio di programmazione dinamica per la raggiungibilità tra tutte le coppie di vertici.},
