...
\begin{lstlisting}[
    language=Python,
    caption={Classe astratta di base che include una classe non pubblica \_Item per la memorizzazione di coppie chiave-valore.},
    captionpos=t,
    label={lst:MapBase},
]
...
\begin{lstlisting}[
    language=Python,
    caption={Implementazione di una sorted map utilizzando un albero di ricerca binario.},
    captionpos=t,
    label={lst:BST},
]
